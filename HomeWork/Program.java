...
Критерии оценивания: Слушатель написал приложение, которое запрашивает у пользователя 
следующие данные, разделенные пробелом: Фамилия Имя Отчество дата _ рождения номер _ телефона пол
*/
...
public class Program {
    public static void main(String[] args) {
        ExaminationData parsData = new ExaminationData(); 
        ...
        System.out.println("Записанные данные: " + data);       
        System.out.println("Название записанного файла: " + filePath);
